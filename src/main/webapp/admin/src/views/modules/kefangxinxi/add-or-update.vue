          ...
          <el-form-item class="input" label="类别" prop="leibie">
              <el-input v-model="ruleForm.leibie" 
                placeholder="类别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="星级" prop="xingji">
          <el-input v-model="ruleForm.xingji" 
              placeholder="星级" clearable  :readonly="ro.xingji"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    jiudianmingchengChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.leibie){
                this.ruleForm.leibie = data.data.leibie
              }
                                                if(data.data.xingji){
                this.ruleForm.xingji = data.data.xingji
              }
                                                if(data.data.jiudiandizhi){
                this.ruleForm.jiudiandizhi = data.data.jiudiandizhi
              }
                                                if(data.data.zixundianhua){
                this.ruleForm.zixundianhua = data.data.zixundianhua
              }
                                                                                                } else {
          this.$message.error(data.msg);
        }
