        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kefangtupian" label="客房图片" prop="kefangtupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.kefangtupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客房状态" prop="kefangzhuangtai">
          <el-input v-model="ruleForm.kefangzhuangtai" 
              placeholder="客房状态" clearable  :readonly="ro.kefangzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" v-if="ruleForm.zongjiage" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入住人数" prop="ruzhurenshu">
          <el-input v-model="ruleForm.ruzhurenshu" 
              placeholder="入住人数" clearable  :readonly="ro.ruzhurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入住人数" prop="ruzhurenshu">
              <el-input v-model="ruleForm.ruzhurenshu" 
                placeholder="入住人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.ruzhushijian" label="入住时间" prop="ruzhushijian">
              <el-input v-model="ruleForm.ruzhushijian" 
                placeholder="入住时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="留言备注" prop="liuyanbeizhu">
          <el-input v-model="ruleForm.liuyanbeizhu" 
              placeholder="留言备注" clearable  :readonly="ro.liuyanbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="留言备注" prop="liuyanbeizhu">
              <el-input v-model="ruleForm.liuyanbeizhu" 
                placeholder="留言备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                                                    zongjiage:{
                                                                                                                                                                                                                                                                                                                                                get: function () {
        return 1*this.ruleForm.kefangjiage*this.ruleForm.ruzhutianshu
      }
    },
                                                                                                                                                  },
  created() {
