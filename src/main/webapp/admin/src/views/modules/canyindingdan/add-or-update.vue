          ...
          <el-form-item class="input" v-if="ruleForm.dingdanbianhao" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐饮名称" prop="canyinmingcheng">
          <el-input v-model="ruleForm.canyinmingcheng" 
              placeholder="餐饮名称" clearable  :readonly="ro.canyinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐饮名称" prop="canyinmingcheng">
              <el-input v-model="ruleForm.canyinmingcheng" 
                placeholder="餐饮名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="客房名称" prop="kefangmingcheng">
              <el-input v-model="ruleForm.kefangmingcheng" 
                placeholder="客房名称" readonly></el-input>
                                                                                                                                                      ...
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="留言备注" prop="liuyanbeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="留言备注"
                  v-model="ruleForm.liuyanbeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.liuyanbeizhu" label="留言备注" prop="liuyanbeizhu">
                    <span>{{ruleForm.liuyanbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanbianhao = true;
            continue;
	            	            ...
	            	            if(o=='canyinmingcheng'){
            this.ruleForm.canyinmingcheng = obj[o];
	    this.ro.canyinmingcheng = true;
            continue;
          }
	            	            if(o=='fenlei'){
	    ...
	    this.ro.xiadanshijian = true;
            continue;
	            	            ...
	            	            if(o=='liuyanbeizhu'){
            this.ruleForm.liuyanbeizhu = obj[o];
	    this.ro.liuyanbeizhu = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `canyindingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.canyindingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
