          ...
          <el-form-item class="input" label="客房价格" prop="kefangjiage">
              <el-input v-model="ruleForm.kefangjiage" 
                placeholder="客房价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续订天数" prop="xudingtianshu">
          <el-input v-model="ruleForm.xudingtianshu" 
              placeholder="续订天数" clearable  :readonly="ro.xudingtianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续订天数" prop="xudingtianshu">
              <el-input v-model="ruleForm.xudingtianshu" 
                placeholder="续订天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="入住时间" prop="ruzhushijian">
              <el-input v-model="ruleForm.ruzhushijian" 
                placeholder="入住时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="续订时间" prop="xudingshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xudingshijian" 
                type="datetime"
                placeholder="续订时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xudingshijian" label="续订时间" prop="xudingshijian">
              <el-input v-model="ruleForm.xudingshijian" 
                placeholder="续订时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                zongjiage:{
                                                                                                                                                                                                                                                                          get: function () {
        return 1*this.ruleForm.kefangjiage*this.ruleForm.xudingtianshu
      }
    },
                                                                                                                          },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ruzhushijian = true;
            continue;
	            	            ...
	            	            if(o=='xudingshijian'){
            this.ruleForm.xudingshijian = obj[o];
	    this.ro.xudingshijian = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kefangxuding/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kefangxudingCrossAddOrUpdateFlag = false;
                  this.parent.search();
