...
export default {
                	        ...
                	        canyinmingcheng: '',
	                        	        ...
	                        	        xiangqing: '',
                                                    ...
                                                    fenleiOptions: [],
                                                                                          rules: {
                  canyinmingcheng: [
                            { required: true, message: '餐饮名称不能为空', trigger: 'blur' },
                                    	                                                              ],
                  jiudianmingcheng: [
                                    	                                                              ],
                  fenlei: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiudiancanyin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiudiancanyinCrossAddOrUpdateFlag = false;
                  this.parent.search();
