  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="酒店地址" prop="jiudiandizhi">
              <el-input v-model="ruleForm.jiudiandizhi" 
                placeholder="酒店地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入住时间" prop="ruzhushijian">
          <el-input v-model="ruleForm.ruzhushijian" 
              placeholder="入住时间" clearable  :readonly="ro.ruzhushijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入住时间" prop="ruzhushijian">
              <el-input v-model="ruleForm.ruzhushijian" 
          ...
          <el-form-item class="input" v-if="ruleForm.tuifangshijian" label="退房时间" prop="tuifangshijian">
              <el-input v-model="ruleForm.tuifangshijian" 
                placeholder="退房时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="客房评分" prop="kefangpingfen">
          <el-select v-model="ruleForm.kefangpingfen" placeholder="请选择客房评分">
            <el-option
                v-for="(item,index) in kefangpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="客房评分" prop="kefangpingfen">
	      <el-input v-model="ruleForm.kefangpingfen"
                placeholder="客房评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="餐饮评分" prop="canyinpingfen">
          <el-select v-model="ruleForm.canyinpingfen" placeholder="请选择餐饮评分">
            <el-option
                v-for="(item,index) in canyinpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="餐饮评分" prop="canyinpingfen">
	      <el-input v-model="ruleForm.canyinpingfen"
                placeholder="餐饮评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务评分" prop="fuwupingfen">
        ...
        <div v-else>
          <el-form-item class="input" label="服务评分" prop="fuwupingfen">
                	        ...
                	        kefangmingcheng: '',
	                        	        ...
	                        	        shouji: '',
	                        	                        	        shhf: '',
                                                                                                                          ...
                                                                                                                          kefangpingfenOptions: [],
                                canyinpingfenOptions: [],
                                fuwupingfenOptions: [],
                                                                                                        rules: {
                  kefangmingcheng: [
                                    	                                                              ],
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tuifangshijian = true;
            continue;
	            	            ...
	            	            if(o=='kefangpingfen'){
            this.ruleForm.kefangpingfen = obj[o];
	    this.ro.kefangpingfen = true;
            continue;
          }
	            	            if(o=='canyinpingfen'){
            this.ruleForm.canyinpingfen = obj[o];
	    this.ro.canyinpingfen = true;
            continue;
          }
	            	            if(o=='fuwupingfen'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                        ...
                                                                                                                                                                        this.kefangpingfenOptions = "1,2,3,4,5".split(',')
                                        this.canyinpingfenOptions = "1,2,3,4,5".split(',')
